...
lre_node::lre_node(opd op1_, opd op2_, ast_node *n1, node_type ty_):ast_node(n1, NULL),n3(NULL),opd1(op1_),opd2(op2_),ty(ty_){}
...
comp_node::comp_node(opd opd1_, opd opd2_, int val_, comp_type op_):ast_node(NULL, NULL),opd1(opd1_),opd2(opd2_),val(val_),op(op_){};
comp_node::comp_node(opd opd1_, opd opd2_, opd opd3_, int val_, comp_type op_):ast_node(NULL, NULL),opd1(opd1_),opd2(opd2_),opd3(opd3_),val(val_),op(op_){};
